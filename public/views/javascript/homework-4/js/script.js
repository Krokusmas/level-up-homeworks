...
// Task 1
// Есть else или нет - без разницы, программа работает одинаково. В варианте без else проверяется условие функции, если оно не верно, то не указано, что делать, код просто выполняется дальше и получает команду вывести сообщение с подтверждением. Также сам по себе if не подразумевает прерывания цикла при невыполнении своего условия.  
